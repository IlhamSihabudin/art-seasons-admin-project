...
export const UserAdminPage = () => {
  const { data: listUser, isLoading } = useGet<ResponseApiList<User>>("admin-user", "/users?limit=10000")
  ...
  return (
    <section className='space-y-5'>
      ...
      <div className='flex items-center gap-3'>
        ...
        <Link to='/users/admin/create' className={`${buttonVariants()} gap-2`}>
          <Plus size={16} />
          Add User
        </Link>
