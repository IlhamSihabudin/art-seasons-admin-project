...
export const ViewingRoomListPage = () => {
  ...
  return (
    <section className='space-y-5'>
      <h1 className='font-bold text-3xl'>Viewing Room</h1>
      <div className='flex items-center gap-3'>
        <Button variant='outline' className='gap-2'>
          <ListFilter size={16} />
          Filters
        </Button>
        <Link to='/content-management/artists/create' className={`${buttonVariants()} gap-2`}>
          <Plus size={16} />
          Add New
        </Link>
  ...
  return [
    {
      ...
      cv: {
        name: 'CV Wiscaksono',
        url: 'https://github.com/wiscaksono'
      }
    }
  ]
}
