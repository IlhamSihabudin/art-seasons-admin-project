...
export const ArtistsTab = ({ callback, artworkDetail, formInput, paramsId }: { callback: (value: boolean) => void, artworkDetail: ArtworkDetail[], formInput: CollectionBodyRequest, paramsId: number }) => {
  ...
  const handleSubmitForm = async () => {
    ...
    try {
      await API.post<typeof body, ResponseApi<Collection>>(`/viewing-room/collection/${paramsId}`, body, {
