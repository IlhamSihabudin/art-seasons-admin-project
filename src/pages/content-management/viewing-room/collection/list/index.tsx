...
import { Collection, ResponseApiList } from '@/types/API'
import { useGet } from '@/hooks/useGet'

export const ViewingRoomListPage = () => {
  const { data, isLoading } = useGet<ResponseApiList<Collection>>('viewing-room-collection', '/viewing-room/collection?limit=10000')
  ...
  return (
    <section className='space-y-5'>
      ...
      <div className='flex items-center gap-3'>
        ...
        <Link to='/content-management/viewing-room/collection/create' className={`${buttonVariants()} gap-2`}>
          <Plus size={16} />
          Add New
        </Link>
