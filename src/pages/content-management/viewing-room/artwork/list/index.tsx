...
import { ArtworkRalation, ResponseApiList } from '@/types/API'
import { useGet } from '@/hooks/useGet'

export const ViewingRoomListPage = () => {
  const { data, isLoading } = useGet<ResponseApiList<ArtworkRalation>>('viewing-room-artwork', '/viewing-room/artwork?limit=10000')
  ...
  return (
    <section className='space-y-5'>
      ...
      <div className='flex items-center gap-3'>
        ...
        <Link to='/content-management/viewing-room/artwork/create' className={`${buttonVariants()} gap-2`}>
          <Plus size={16} />
          Add New
        </Link>
