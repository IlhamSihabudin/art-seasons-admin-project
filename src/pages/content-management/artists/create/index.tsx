    ...
    <section className='space-y-5'>
      ...
      <form className='grid md:grid-cols-2 md:gap-10 gap-5 container' encType='multipart/form-data' onSubmit={handleSubmit}>
        <fieldset className='md:space-y-7 space-y-3'>
          ...
          <fieldset>
            <Input label='Profile Picture' type='file' required onChange={(e: React.FormEvent<HTMLInputElement>) => {
          ...
          <fieldset>
            ...
            <RadioGroup className='flex items-center'>
              <div className='flex items-center space-x-2'>
                <input type="radio" value='1' id='visible' name="isVisible" onChange={(e: React.FormEvent<HTMLInputElement>) => setIsVisible((e.target as HTMLInputElement).value)}/>
