...
export const GeneralTab = ({ formData, setFormData, initialImage, initialFile }: { formData: ArtFairForm; setFormData: React.Dispatch<React.SetStateAction<ArtFairForm>>; initialImage: string, initialFile: string }) => {
