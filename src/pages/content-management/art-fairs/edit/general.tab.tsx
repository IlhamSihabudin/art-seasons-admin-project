...
export const GeneralTab = ({ formData, setFormData, initialImage }: { formData: ArtFairForm; setFormData: React.Dispatch<React.SetStateAction<ArtFairForm>>; initialImage: string }) => {
