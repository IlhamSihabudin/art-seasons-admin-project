...
export const GeneralTab = ({ callback, formInput, form }: { callback: (value: boolean) => void, formInput: (value: ArtFairForm) => void, form?: ArtFairForm }) => {
    ...
    <section>
      <form className='grid md:grid-cols-2 md:gap-10 gap-5 container' onSubmit={handleNextTab}>
        <fieldset className='md:space-y-7 space-y-3'>
          <Input label='Art Fair Name' required placeholder='Enter art fair name' ref={fullname} defaultValue={form?.name}/>
