    ...
    <section>
      <form className='grid md:grid-cols-2 md:gap-10 gap-5 container'>
        <fieldset className='md:space-y-7 space-y-3'>
          <Input label='Art Fair Name' required placeholder='Enter art fair name' />
          <Input label='Tag' required placeholder='Enter tag name (recommended to be less than 10 characters)' />
          ...
          <fieldset>
            ...
            <div className='flex items-center justify-between gap-4'>
              <Input placeholder='Search location' required wrapperClassName='w-full' />
              <Button>Enter</Button>
            </div>
          </fieldset>
          <fieldset>
