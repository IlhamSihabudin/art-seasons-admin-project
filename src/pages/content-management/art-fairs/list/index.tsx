...
import { ArtFairs, columns } from './columns'

export const ArtFairsListPage = () => {
  const [data, setData] = useState<ArtFairs[]>([])
  ...
  return (
    <section className='space-y-5'>
      <h1 className='font-bold text-3xl'>Art Fairs</h1>
      <div className='flex items-center gap-3'>
        <Button variant='outline' className='gap-2'>
          <ListFilter size={16} />
          Filters
        </Button>
        <Link to='/content-management/art-fairs/create' className={`${buttonVariants()} gap-2`}>
          <Plus size={16} />
          Add New
        </Link>
...
async function getData(): Promise<ArtFairs[]> {
  return [
    {
      id: 'abcdefgh',
      name: 'Name of Exhibition A',
      tag: 'A-artists-name-A',
      visibility: 'Visible',
      date: new Date(),
