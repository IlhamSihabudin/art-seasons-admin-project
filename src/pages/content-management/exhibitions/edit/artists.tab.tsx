...
import { Artwork, ArtworkDetail, Exhibition, ResponseApi } from '@/types/API'
import { ArtistsRequest } from '../../art-fairs/create/artists.tab'
import { AxiosError } from 'axios'

export const ArtistsTab = ({ callback, artworkDetail, formInput, paramsId }: { callback: (value: boolean) => void, artworkDetail: ArtworkDetail[], formInput?: ExhibitionForm, paramsId: number }) => {
  ...
  const handleSubmitForm = async () => {
    ...
    try {
      await API.post<typeof body, ResponseApi<Exhibition>>(`/exhibitions/${paramsId}`, body, {
