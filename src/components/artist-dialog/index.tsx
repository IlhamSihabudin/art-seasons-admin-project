...
export const ArtistsDialog = ({ listArtistArt, callbackSelectedArt }: { listArtistArt: Artwork[], callbackSelectedArt: (value: Record<string, boolean>) => void }) => {
  ...
  const handleSelect = () => {
    callbackSelectedArt(rowSelection)
    setIsOpen(false)
    // setSorting([])
    // setColumnFilters([])
    // setRowSelection({})
